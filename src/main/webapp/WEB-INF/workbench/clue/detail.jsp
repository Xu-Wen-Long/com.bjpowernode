...
<body>
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						...
						<div class="form-group has-feedback">
						    <input type="text" name="name" id="name" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='${pageContext.request.contextPath}/toView/workbench/clue/convert？id=${id}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);"  id="click" data-toggle="modal" data-target="#bundModal" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
	...
	<script>
		$.get("/crm/workbench/clue/toDetail",{
			//这是index里面传进来的id
			'id':'${id}'
		},function (data) {
		...
		for (var i = 0 ; i < activities.length ; i++){
			...
			$("#clueBody").append("<tr>\n" +
					...
					"\t\t\t\t\t\t\t<td><a onclick=\"unbind('"+activities.id+"',$(this))\" href=\"javascript:void(0);\"  style=\"text-decoration: none;\"><span class=\"glyphicon glyphicon-remove\"></span>解除关联</a></td>\n" +
					"\t\t\t\t\t\t</tr>")
		}
		},'json');
		...
		$('#click').click(function () {
			/*refreshRemark()*/
			$.getJSON("/crm/workbench/clue/queryActivities",{
				'name' :$(this).val(),
				'id' : '${id}'
			},function (data) {
				//data:List<Activity>
