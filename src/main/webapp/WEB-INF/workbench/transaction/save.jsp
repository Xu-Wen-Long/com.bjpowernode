...
<body>
	...
	<div style="position:  relative; left: 30px;">
		<h3>创建交易</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
			<button type="button"  onclick="savetransaction()" class="btn btn-primary">保存</button>
			<button type="button" class="btn btn-default">取消</button>
		</div>
		<hr style="position: relative; top: -40px;">
	</div>
	<form class="form-horizontal" id="saveForm" role="form" style="position: relative; top: -30px;">
	...
	$('#create-transactionStage').click(function () {
		$.get("/crm/workbench/tran/stage2Possibility",{
			'stage':$(this).val()
		},function (data) {
		...
		function savetransaction() {
			$.get("/crm/workbench/transaction/saveOrUpdate", $("#saveForm").serialize()
			,function (data) {
				if (data.ok){
